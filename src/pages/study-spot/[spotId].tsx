...
export default function StudySpotDetail() {
  ...
  const handleSubmitReview = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!studySpot || !newReview.text.trim() || !newReview.author.trim())
      return;
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-blue-200 mb-4">
            The study spot you&apos;re looking for doesn&apos;t exist.
          </p>
          <button
            onClick={() => router.push("/")}
  ...
  const getSimilarSpots = () => {
    ...
    return studySpotsData.study_spaces
      .filter(
        (spot) =>
          spot["Type of space"] === studySpot["Type of space"] &&
          spot["Room Number"] !== studySpot["Room Number"]
      )
      .slice(0, 3);
  };
          ...
          <div className="w-full h-full bg-gradient-to-r from-blue-800 to-blue-900 flex items-center justify-center">
            <div className="text-center text-white">
              <div className="text-8xl mb-4">
                {getSpaceIcon(studySpot["Type of space"])}
              </div>
        ...
        <div className="absolute bottom-6 left-6 text-white">
          ...
          <div className="flex items-center gap-4 text-sm">
            <div className="flex items-center gap-1">
              ...
              <span className="ml-1">
                {studySpot.rating.average > 0
                  ? studySpot.rating.average.toFixed(1)
                  : "N/A"}
              </span>
            </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-200">
                    {studySpot.rating.totalReviews}
                  </div>
                  <div className="text-sm text-blue-300">Reviews</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-200">
                    {studySpot["Seating Spaces"]}
                  </div>
            ...
            >
              ...
              <p className="text-blue-200 leading-relaxed mb-6">
                A peaceful, dedicated {studySpot["Type of space"].toLowerCase()}{" "}
                space perfect for {studySpot["Group/Individual"].toLowerCase()}{" "}
                work. This room features comfortable seating, ample natural
                light, and is designed to minimize distractions for students who
                need focused study time.
              </p>
              ...
              <div className="flex items-center gap-6 pb-6 border-b border-white/20">
                <div className="text-center">
                  ...
                  <div className="text-sm text-blue-300">
                    {studySpot.rating.totalReviews} reviews
                  </div>
                </div>
                    ...
                    return [5, 4, 3, 2, 1].map((stars) => {
                      ...
                      return (
                        <div key={stars} className="flex items-center gap-2">
                          <span className="text-sm w-6 text-white">
                            {stars}
                          </span>
                          ...
                          <span className="text-sm text-blue-300 w-8">
                            {count}
                          </span>
                        </div>
                      );
